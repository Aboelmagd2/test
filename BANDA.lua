...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' and Debn(msg) then
local Text = [[
•ᎳᎬᏞᏟΌᎷᎬ ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ⇣
]]
keyboard = {} 
...
if text == '/units' and Debn(msg) then
local Teext =[[
...
if text == '/theytry' and Debn(msg) then
local Teext =[[
