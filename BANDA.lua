...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Aboelmagd2/test/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/test/main/BANDA.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᏟᎻ ᎠᎬᏙ!',callback_data="/units"}},
{{text = 'ᏟᎻ ᎬᏙᎪᏞ', callback_data="/kkky"},{text = 'ͲᎳՏΌᏞ', url="t.me/Quick0k"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceEval&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == '/units' then
local text =[[المبرمجين
]]
keyboard.inline_keyboard = {
	{{text = 'aboalmagd',url="t.me/ABO_ELMAGD2"}},
	}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Xccpp&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/test/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/test/main/File_Bot/"..file)
if res == 200 then
